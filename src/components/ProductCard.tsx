...
const ProductCard: React.FC<propsType> = ({name, author, price, img, id}) => {
  return (
    
      <Link to={`/book-details/${id}`} className="border-2 cursor-pointer border-slate-700 hover:scale-105 duration-500 relative">
